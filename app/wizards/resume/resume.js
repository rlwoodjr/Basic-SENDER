...
function recoverCrashedJob() {
    ...
    <form>
      ...
      <hr>
      <input type="checkbox" data-role="checkbox" data-caption="Use Work Coordinates for Z-Safe Move:" data-caption-position="left" id="recoveryUseWpos" checked>
    </form>
    ...
    <div class="remark warning">
      NOTE: Recovering GCODE is a risky operation. You are also responsible for ensuring that work origin is correctly set.  Use at your own risk.
    </div>
    `
    Metro.dialog.create({
